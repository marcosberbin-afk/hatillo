...
if ($_SESSION['usuario']['rol_id'] == 1) {
	$personales = $personal_obj->Listado($_DB_);
}
												...
												<td class="text-center" width="100">
													...
													<div class="btn-group">
														<a class="btn btn-outline btn-info dim"
															href="personal_gestion.php?o=vie&id=<?= $personal['hash']; ?>"
														...
														if ($_SESSION['usuario']['rol_id'] == 1 or $_SESSION['usuario']['rol_id'] == 2) {
															...
															<a class="btn btn-outline btn-warning dim"
																href="personal_gestion.php?o=mod&id=<?= $personal['hash']; ?>"
																type="button" alt="Modificar" title="Modificar"><i
																	class="fa fa-pen"></i></a>

															<a class="btn btn-outline btn-danger dim"
																href="personal_gestion.php?o=del&id=<?= $personal['hash']; ?>"
					...
					<div class="col-md-3">
						<div class="card  card-<? echo $color; ?>">
							...
							<div class="card-body">
								...
								<form action="./personal_gestion.php" method="POST">
